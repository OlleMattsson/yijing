...
in the commentary called WÍn Yen , later formed the bridge connecting
...
below CHÍN THE AROUSING, THUNDER

The name of the hexagram, Chun, really connotes a blade of grass pushing against an obstacle as it sprouts out of the earth--hence the meaning, "difficulty at the beginning." The hexagram indicates the way in which heaven and earth bring forth individual beings. It is their first meeting, which is beset with difficulties. The lower trigram ChÍn is the Arousing; its motion is upward and its image is thunder. The upper trigram K'an stands for the Abysmal, the dangerous. Its motion is downward and its image is rain. The situation points to teeming, chaotic profusion; thunder and rain fill the air. But the chaos clears up. While the Abysmal sinks, the upward movement eventually passes beyond the danger. A thunderstorm brings release from tension, and all things breathe freely again. 
...
Inferior people are ready to flatter their superiors in a servile
...
Inferior people who have risen to power illegitimately do not feel
...
The time undergoes a change. The right man, able to restore order,
...
The standstill does not last forever. However, it does not cease of
...
<a name="13"></a>
13. T'ung JÍn / Fellowship with Men
-----------------------------------
...
There is danger here of formation of a separate faction on the basis
...
Here the reconciliation that follows quarrel mover nearer. It is true
...
The warm attachment that springs from the heart is lacking here. We
...
The fire in heaven above shines far, and all things stand out in the
...
This hexagram is made up of the trigrams KÍn, Keeping Still,
...
above CHÍN THE AROUSING, THUNDER
below K'UN THE RECEPTIVE, EARTH
...
all weak. The attribute of the upper trigram, ChÍn, is movement;
...
ChÍn, the Arousing, which has the attribute of movement, is below.
...
<a href="http://www2.unipr.it/~deyoung/I_Ching_Wilhelm_Translation.html#6">6</a>, which refers to civil suits.
...
Li, clarity, and ChÍn, excitement. Li is yielding, ChÍn is hard.
...
Ch'ien, heaven is above; ChÍn, movement, is below. The lower
trigram ChÍn is under the influence of the strong line it has received
...
In springtime when thunder, life energy, begins to move again under
...
The Creative is tamed by KÍn, Keeping Still. This produces
...
firm in the sense of holding together; the trigram KÍn which holds
...
KÍn indicates firmness and truth. Both point to light and clarity and
...
above TUI THE JOYOUS, LAKE
below KÍN KEEPING STILL, MOUNTAIN
...
the lower is KÍn, Keeping still. By its persistent, quiet influence,
the lower, rigid trigram stimulates the upper, weak trigram, which responds
to this stimulation cheerfully and joyously. KÍn, the lower trigram,
...
The strong trigram ChÍn is above, the weak trigram Sun below.
...
higher. The upper trigram is ChÍn, the Arousing; the lower is ch'ien,
the Creative. Ch'ien is strong, ChÍn produces movement. The union
...
The hexagram represents the sun rising over the earth. It is therefore
...
and peace. The sovereign rewards him richly and invites him to a closer
intimacy.
...
The light of the sun rises over the earth is by nature clear. The
...
<a name="37"></a>
37. Chia JÍn / The Family [The Clan]
...
reverence of the son is then carried over to the prince in the form of faithfulness
to duty; the affection and correctness of behavior existing between the
...
moral practice is created, and this is later widened to include human relationships
in general.
...
nature, man and woman, when reconciled, bring about the creation and reproduction
of life. In the world of visible things, the principle of opposites makes
...
This refers to a time in which tensions and complications begin to
...
A thunderstorm has the effect of clearing the air; the superior man
...
Even if only one inferior man is occupying a ruling position in a
...
Second, a compromise with evil is not possible; evil must under all circumstances
...
When the water of a lake has risen up to heaven, there is reason to
...
If the water in the lake gathers until it rises above the earth, there
...
Adapting itself to obstacles and bending around them, wood in the
...
Mount Ch'i is in the western China, the homeland of King WÍn,
...
into power. At that time King WÍn introduced his illustrious helpers
...
Times of adversity are the reverse of times of success, but they can
...
The trigram Sun, wood, is below, and the trigram K'an, water, is above
...
then proceed in the right way, so that he gladdens the people and, by enlightening
them, prevents excesses. Furthermore, he must be quite free of selfish aims
...
Fire below and the lake above combat and destroy each other. So too
...
The fate of fire depends on wood; as long as there is wood below,
...
<a name="51"></a>
51. ChÍn / The Arousing (Shock, Thunder)

above CHÍN THE AROUSING, THUNDER
below CHÍN THE AROUSING, THUNDER

The hexagram ChÍn represents the eldest son, who seizes rule
...
and KÍn (mountain, stillness) below, i.e., within. A tree on a
...
Above we have ChÍn, the eldest son, and below, Tui, the youngest
...
have for each other; HÍng, DURATION 
...
wrong turns may be taken, leading to endless misunderstandings and disagreements.
...
<a name="55"></a>
55. FÍng / Abundance [Fullness]

above CHÍN THE AROUSING, THUNDER
below LI THE CLINGING, FIRE

ChÍn is movement; Li is flame, whose attribute is clarity. Clarity
...
<a href="http://www2.unipr.it/~deyoung/I_Ching_Wilhelm_Translation.html#21">21</a>, in which thunder and lightning similarly appear
...
possible to investigate the facts exactly, and shock [ChÍn] without
...
the mountain, KÍn, stands still; above it fire, Li, flames up
...
When grass on a mountain takes fire, there is bright light. However,
...
toward God and man and achieves something. Under certain conditions, intimidation
...
<a href="http://www2.unipr.it/~deyoung/I_Ching_Wilhelm_Translation.html#45">45</a>. In the latter, the subject is the bringing together
...
was overcome and rigidity dissolved. A further means to the same end is co-operation
...
In the autumn and winter, water begins to freeze into ice. When the
...
is brought by a bird. In Ta Kuo, PREPONDERANCE OF THE GREAT 

<a href="http://www2.unipr.it/~deyoung/I_Ching_Wilhelm_Translation.html#28">28</a>, the four strong, heavy lines within, supported
...
Thunder on the mountain is different from thunder on the plain. In
...
and let thing take their course without troubling over details. Such indifference
...
When water in a kettle hangs over fire, the two elements stand in
relation and thus generate energy (cf. the production of steam). But the
resulting tension demands caution. If the water boils over, the fire is extinguished
